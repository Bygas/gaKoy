...
const NPC_RECIPE_MAP: { npcId: string; level: 'acquaintance' | 'friendly' | 'bestFriend'; recipeId: string }[] = [
  // 相识
  { npcId: 'Hasan Enişte', level: 'acquaintance', recipeId: 'radish_soup' },
  { npcId: 'Aylin', level: 'acquaintance', recipeId: 'braised_carp' },
  { npcId: 'Hekim Dede', level: 'acquaintance', recipeId: 'herbal_porridge' },
  { npcId: 'Elif', level: 'acquaintance', recipeId: 'osmanthus_cake' },
  { npcId: 'İsmail', level: 'acquaintance', recipeId: 'miner_lunch' },
  { npcId: 'Mıstık', level: 'acquaintance', recipeId: 'sweet_osmanthus_tea' },
  // 相知
  { npcId: 'Hasan Enişte', level: 'friendly', recipeId: 'aged_radish_stew' },
  { npcId: 'Aylin', level: 'friendly', recipeId: 'maple_grilled_fish' },
  { npcId: 'Hekim Dede', level: 'friendly', recipeId: 'herbal_pill' },
  { npcId: 'Elif', level: 'friendly', recipeId: 'embroidered_cake' },
  { npcId: 'İsmail', level: 'friendly', recipeId: 'deep_mine_stew' },
  { npcId: 'Mıstık', level: 'friendly', recipeId: 'wild_berry_jam' },
  // 挚友
  { npcId: 'Hasan Enişte', level: 'bestFriend', recipeId: 'farmers_feast' },
  { npcId: 'Aylin', level: 'bestFriend', recipeId: 'autumn_moon_feast' },
  { npcId: 'Hekim Dede', level: 'bestFriend', recipeId: 'longevity_soup' },
  { npcId: 'Elif', level: 'bestFriend', recipeId: 'lovers_pastry' },
  { npcId: 'İsmail', level: 'bestFriend', recipeId: 'forgemasters_meal' },
  { npcId: 'Mıstık', level: 'bestFriend', recipeId: 'spirit_fruit_wine' },
  // 新增：动物产品相关食谱
  { npcId: 'İbo', level: 'friendly', recipeId: 'goat_milk_soup' },
  { npcId: 'İbo', level: 'bestFriend', recipeId: 'truffle_fried_rice' },
  { npcId: 'Hekim Dede', level: 'bestFriend', recipeId: 'antler_soup' },
  { npcId: 'Hasan Enişte', level: 'bestFriend', recipeId: 'camel_milk_tea' }
]
...
const checkAchievementRecipes = () => {
  ...
  const checks: { condition: boolean; recipeId: string; message: string }[] = [
    ...
    {
      condition:
        (['Hasan Enişte', 'Elif', 'İsmail', 'Aylin', 'Hekim Dede', 'Mıstık'] as const).filter(id =>
