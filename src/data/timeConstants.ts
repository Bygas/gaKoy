...
export const NPC_SCHEDULES: NpcScheduleEntry[] = [
  // 原有 NPC
  { npcId: 'Hasan Enişte', availableDays: 'all', availableHours: { from: 8, to: 20 } },
  { npcId: 'Elif', availableDays: 'all', availableHours: { from: 9, to: 21 } },
  { npcId: 'İsmail', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri'], availableHours: { from: 7, to: 18 } },
  { npcId: 'Aylin', availableDays: 'all', availableHours: { from: 6, to: 22 } },
  { npcId: 'Hekim Dede', availableDays: 'all', availableHours: { from: 8, to: 19 } },
  { npcId: 'Mıstık', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat'], availableHours: { from: 9, to: 17 } },
  // 新增可婚 NPC
  { npcId: 'Bahar', availableDays: 'all', availableHours: { from: 7, to: 20 } },
  { npcId: 'Nazan', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri'], availableHours: { from: 10, to: 19 } },
  { npcId: 'Suna', availableDays: 'all', availableHours: { from: 8, to: 20 } },
  { npcId: 'Zeyno', availableDays: 'all', availableHours: { from: 10, to: 23 } },
  { npcId: 'Cemil', availableDays: 'all', availableHours: { from: 8, to: 21 } },
  { npcId: 'Demir', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat'], availableHours: { from: 7, to: 18 } },
  { npcId: 'Baran', availableDays: ['tue', 'thu', 'sat', 'sun'], availableHours: { from: 6, to: 16 } },
  { npcId: 'İbo', availableDays: 'all', availableHours: { from: 6, to: 19 } },
  { npcId: 'Mahir', availableDays: 'all', availableHours: { from: 12, to: 23 } },
  // 新增不可婚 NPC
  { npcId: 'Fatma Teyze', availableDays: 'all', availableHours: { from: 6, to: 19 } },
  { npcId: 'Mustafa Usta', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat'], availableHours: { from: 7, to: 18 } },
  { npcId: 'Ali Usta', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat'], availableHours: { from: 7, to: 18 } },
  { npcId: 'Emine Nine', availableDays: 'all', availableHours: { from: 8, to: 17 } },
  { npcId: 'Balıkçı Dede', availableDays: 'all', availableHours: { from: 6, to: 20 } },
  { npcId: 'Hoca Efendi', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri'], availableHours: { from: 8, to: 17 } },
  { npcId: 'Nuriye Teyze', availableDays: 'all', availableHours: { from: 8, to: 20 } },
  { npcId: 'Seyyar Salih', availableDays: ['wed', 'sat', 'sun'], availableHours: { from: 9, to: 18 } },
  { npcId: 'Bekçi Osman', availableDays: 'all', availableHours: { from: 18, to: 26 } },
  { npcId: 'Hatice Abla', availableDays: 'all', availableHours: { from: 5, to: 16 } },
  { npcId: 'Zehra', availableDays: 'all', availableHours: { from: 9, to: 18 } },
  { npcId: 'Yaman', availableDays: 'all', availableHours: { from: 8, to: 20 } },
  { npcId: 'Meryem', availableDays: 'all', availableHours: { from: 8, to: 19 } },
  { npcId: 'Rıza Dayı', availableDays: 'all', availableHours: { from: 10, to: 22 } },
  { npcId: 'Muhtar Mehmet', availableDays: ['mon', 'tue', 'wed', 'thu', 'fri'], availableHours: { from: 8, to: 18 } },
  { npcId: 'Yasemin', availableDays: 'all', availableHours: { from: 8, to: 18 } },
  { npcId: 'Kahveci Bekir', availableDays: 'all', availableHours: { from: 9, to: 22 } },
  { npcId: 'Kemal Amca', availableDays: 'all', availableHours: { from: 6, to: 18 } },
  { npcId: 'Ufuk', availableDays: 'all', availableHours: { from: 7, to: 18 } }
]
