...
export const HEART_EVENTS: HeartEventDef[] = [
  ...
  // ============================================================
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        choices: [
          {
            text: '"这首诗写的是对美好生活的向往，就像gaKöy一样。"',
            friendshipChange: 120,
            response:
              '柳娘的眼睛亮了起来："你也这样觉得吗？父亲给这个村子取名gaKöy，就是希望这里能像诗中描绘的那样美好。能遇到懂诗的人，真好。"'
          },
          {
            text: '"说实话，我对古诗不太了解……"',
            friendshipChange: 40,
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '"这是gaKöy的族碑。"柳娘轻声说，"上面记载着两百年前的事。gaKöy并不是一个普通的村庄——它是当年一群人为了躲避战乱，翻山越岭找到这片隐秘山谷后建立的。他们在这里种桃树、修水渠，发誓再也不与外面的纷争有任何牵扯。"',
        choices: [
          {
            text: '"原来如此……难怪这里与世隔绝，像世外桃源一般。"',
            friendshipChange: 120,
            response:
              '柳娘点点头，眼眶微红："是啊。我的祖辈们世世代代守着这个秘密。父亲常说，gaKöy的宁静是用无数人的牺牲换来的，我们必须珍惜。"'
          },
          {
            text: '"你为什么要告诉我这些？"',
            friendshipChange: 80,
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '柳娘低下头，双手绞着衣角："你来gaKöy之前，我以为我会一辈子守着这个小村庄，读我的诗，过平淡的日子。可是你来了以后，一切都不同了。我看着你开荒种田、帮助乡亲、让这片土地重新焕发生机……我的心里，也像是开了一片桃花。"她抬起头，眼中有泪光闪烁，"我……喜欢你。"',
        choices: [
          {
      ...
      {
        text: '一阵夜风吹过，漫天桃花纷纷扬扬地落下。你和柳娘并肩站在花雨之中，月光温柔地笼罩着一切。这一刻，gaKöy真的像是人间仙境。远处隐约传来溪水的声音，像是这片土地在轻声祝福。'
      }
    ]
  },
  ...
  },
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            friendshipChange: 120,
            response:
              '秋月用力地点点头，眼里闪着骄傲和思念交织的光："她是全gaKöy最厉害的钓手！比我还厉害一百倍！……我一直想把她的本事全学会，然后教给更多的人。这样她就永远不会被忘记。"'
          }
        ]
      },
      {
      ...
      {
        text: '忽然，秋月转过身来，认真地看着你。夕阳在她的眼睛里跳动。"我一直在想该怎么说……"她难得地有些扭捏，用手指绕着发梢，"你知道吗？自从你来了gaKöy，我每天都特别特别开心。以前我觉得自己一个人也可以，可是现在……"她深吸一口气，然后一股脑地说出来，"我喜欢你！超级喜欢！比喜欢钓鱼还喜欢！这已经是我能说出的最高级别的喜欢了！"说完她涨红了脸，把头埋进膝盖里。'
      }
    ]
  },
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '推开门，你愣住了——画室四面墙壁上挂满了画，全部是gaKöy的风景。春天的桃花溪、夏天的荷塘、秋天的金黄稻田、冬天的雪山。而每一幅画里，都有一个模糊的人影在田间劳作。'
      },
      {
  ...
  },
  {
    ...
    scenes: [
      {
        text: '中秋之夜，红豆拉你上了村后的小山丘。她扛了一坛酒，带了两只碗。月亮又大又圆，挂在漆黑的天幕上，下面是gaKöy的万家灯火。'
      },
      {
  ...
  // ============================================================
  {
    ...
    scenes: [
      ...
      {
        text: '他合上书，邀请你坐下。"你来gaKöy之前，是在城里生活吧？为何愿意放弃都市的繁华，来这乡野之地耕种？"',
        choices: [
          {
      ...
      {
        text: '日暮时分，丹青起身整理书卷。他忽然开口："在下游学多年，去过很多地方，见过很多人。但真正让我想停留的……只有gaKöy。"他微微一笑，"因为这里有值得停留的人。"他没有说那个人是谁，但他看向你的目光里有答案。'
      }
    ]
  },
  {
    ...
    scenes: [
      ...
      {
        text: '"写不出来。"他看到你，苦笑着摇头，"我一直在写一本关于gaKöy历史的书，想把这里的故事留给后人。可是……写了三年了，总觉得差了什么。"'
      },
      {
        text: '他拿起一沓手稿给你看。字迹工整秀丽，记载着gaKöy的地理、物产、人文。确实写得很好——但正如他所说，总觉得缺少一种活力和温度。',
        choices: [
          {
  ...
  },
  {
    ...
    scenes: [
      ...
      {
        text: '眼前的景象让你忘记了呼吸——脚下是无边无际的云海，朝阳从云层中升起，把天空染成了金红色。gaKöy的炊烟从云海中升起，像是一座飘在仙境里的村庄。',
        choices: [
          {
  ...
  // --- 柳娘 知己 ---
  {
    ...
    scenes: [
      ...
      { text: '她先写了一句："桃花坞里桃花庵，桃花庵下桃花仙。"然后把笔递给你。"知己之间，以诗会友，是最雅致的事。"' },
      {
        ...
        choices: [
          { text: '"柳娘的才华让人叹服。"', friendshipChange: 120, response: '柳娘低头笑了笑。"有{player}这般知己，才华才有意义。"' },
          {
            text: '"以后每个月圆之夜都来诗会吧。"',
            friendshipChange: 80,
    ...
    scenes: [
      ...
      { text: '他带你到矿洞最深处一个隐秘的角落。岩壁上天然形成了两道并行的矿脉，一金一银，蜿蜒交织却始终不分离。' },
      {
        ...
        choices: [
          ...
          { text: '"你真是个重情义的人。"', friendshipChange: 80, response: '阿石别过脸去，耳根红了。"……知己之间该有个属于两个人的地方。"' }
        ]
      },
    ...
    scenes: [
      ...
      { text: '他把布包递给你——里面是两块一模一样的玉石吊坠，翠绿通透，用红绳串着。"这是那条矿脉上唯一松动的两块石头。一人一块。"' },
      {
        ...
        choices: [
          ...
          { text: '"阿石，有你这个知己，我很幸运。"', friendshipChange: 120, response: '阿石沉默了很久，然后轻轻点头。"……我也是。"' }
        ]
      }
    ]
  },
    ...
    scenes: [
      ...
      { text: '你们并排坐在岩石上，各执一竿。秋月难得安静了一会儿，然后说："知己嘛，就是可以一起发呆也不尴尬的人。"' },
      {
        ...
        choices: [
          ...
          { text: '"这个钓点真的太棒了！"', friendshipChange: 80, response: '"对吧对吧！"秋月开心得直拍手，"只有知己才有资格来这里！"' }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    scenes: [
      ...
      { text: '展开画轴，是一幅工笔画——画中人的衣着、神态都与你一模一样，背景是gaKöy的四季。笔触细腻到每一片桃花瓣都清晰可见。' },
      {
...
export const WEDDING_EVENT: HeartEventDef = {
  ...
  scenes: [
    {
      text: '今天是你期盼已久的日子。清晨的阳光洒在gaKöy的广场上，村民们早早布置好了红绸和灯笼。陈伯在门口笑呵呵地招呼着来客，王大婶忙前忙后张罗着喜宴。'
    },
    {
      text: '你穿上了崭新的喜服，站在广场中央。柳村长作为证婚人，清了清嗓子说道："今日良辰吉日，gaKöy又添一桩喜事。"人群中响起了喝彩声。'
    },
    {
      text: '你的心上人缓步走来，身着红装，面带羞涩的笑容。你们在众人的见证下，交换了信物。柳村长宣布："礼成！百年好合，白头偕老！"'
    },
    {
      text: '喜宴上，胖婶端来了拿手好菜，老陆搬出了珍藏的好酒，周秀才即兴写了一首贺词。小满和石头在桌下偷吃点心，阿花好奇地盯着你们看。整个gaKöy都沉浸在欢乐之中。'
    },
    {
