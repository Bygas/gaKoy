...
export const SECRET_NOTES: SecretNoteDef[] = [
  ...
  },
  {
    ...
    type: 'story',
    title: '桃源志·上',
    content: '百年前，一位隐士发现了这片与世隔绝的山谷。谷中桃花遍野，溪水潺潺，宛如世外桃源。他便在此建村定居，取名"gaKöy"。',
    usable: false
  },
  {
    id: 5,
  ...
  },
  {
    ...
    type: 'story',
    title: '桃源志·下',
    content: '隐士去世后，村民们世代守护着这片土地。他们定下规矩：不许砍伐桃花林，不许污染溪水。gaKöy就这样安静地度过了百年时光。',
    usable: false
  },
  {
    id: 9,
  ...
  },
  {
    ...
    type: 'story',
    title: '瀚海商路',
    content: '很久以前，gaKöy并非与世隔绝。一条商路穿过西边的荒原，连接着远方的异域。商人们称那片荒原为"瀚海"，因为沙石浩瀚如海。',
    usable: false
  },
  {
    id: 14,
  ...
  },
  {
    ...
    title: '桃源秘事',
    content:
      'gaKöy的地底深处，据说封印着远古的力量。建村隐士之所以选择此地，并非偶然——他是这股力量的守护者。如今守护者已去，力量渐渐苏醒……这或许就是矿洞中怪物越来越多的原因。',
    usable: false
  },
  // 仙灵线索
  {
