...
export const STORY_QUESTS: MainQuestDef[] = [
  ...
  // ============================================================
  {
    ...
    order: 1,
    title: '新的开始',
    description: '柳村长说，想在gaKöy立足，先从种地开始吧。试着收获5次作物。',
    npcId: 'Muhtar Mehmet',
    objectives: [{ type: 'harvestCrops', label: '累计收获5次作物', target: 5 }],
    moneyReward: 300,
    friendshipReward: [{ npcId: 'Muhtar Mehmet', amount: 20 }]
  },
  {
    id: 'main_1_2',
    chapter: 1,
    ...
    npcId: 'Hasan Enişte',
    objectives: [{ type: 'npcFriendship', label: '与陈伯成为相识', npcId: 'Hasan Enişte', friendshipLevel: 'acquaintance' }],
    moneyReward: 200,
    friendshipReward: [{ npcId: 'Hasan Enişte', amount: 20 }]
  },
  {
    id: 'main_1_3',
    chapter: 1,
    ...
    friendshipReward: [{ npcId: 'Aylin', amount: 20 }]
  },
  {
    id: 'main_1_4',
    chapter: 1,
    ...
    moneyReward: 500,
    friendshipReward: [{ npcId: 'İsmail', amount: 20 }]
  },
  {
    id: 'main_1_5',
    chapter: 1,
    ...
    moneyReward: 300,
    friendshipReward: [{ npcId: 'Fatma Teyze', amount: 20 }]
  },
  {
    id: 'main_1_6',
    chapter: 1,
  ...
  },
  {
    ...
    friendshipReward: [{ npcId: 'Mıstık', amount: 30 }]
  },
  {
    id: 'main_1_8',
    chapter: 1,
    ...
    moneyReward: 500,
    friendshipReward: [{ npcId: 'Hekim Dede', amount: 30 }]
  },
  {
    id: 'main_1_9',
    chapter: 1,
  ...
  // ============================================================
  {
    ...
    moneyReward: 800,
    friendshipReward: [{ npcId: 'Elif', amount: 20 }]
  },
  {
    id: 'main_2_2',
    chapter: 2,
  ...
  },
  {
    ...
    moneyReward: 800,
    friendshipReward: [{ npcId: 'Balıkçı Dede', amount: 20 }]
  },
  {
    id: 'main_2_4',
    chapter: 2,
  ...
  },
  {
    ...
    npcId: 'Ali Usta',
    objectives: [
      { type: 'npcFriendship', label: '与孙铁匠成为相识', npcId: 'Ali Usta', friendshipLevel: 'acquaintance' },
      { type: 'deliverItem', label: '交付铁矿×15', itemId: 'iron_ore', itemQuantity: 15 }
    ],
    moneyReward: 1000,
    friendshipReward: [{ npcId: 'Ali Usta', amount: 30 }]
  },
  {
    id: 'main_2_6',
    chapter: 2,
    ...
    moneyReward: 1000,
    friendshipReward: [{ npcId: 'İbo', amount: 30 }]
  },
  {
    id: 'main_2_7',
    chapter: 2,
  ...
  },
  {
    ...
    order: 9,
    title: '四季物产',
    description: '陈伯说gaKöy物产丰富，多发现一些不同的物品吧。',
    npcId: 'Hasan Enişte',
  ...
  },
  {
    ...
    order: 10,
    title: '小有名气',
    description: '你在gaKöy已经小有名气了。继续积累财富，证明自己的实力。',
    npcId: 'Muhtar Mehmet',
  ...
  },
  {
    ...
    order: 3,
    title: '万物通鉴',
    description: '周秀才对你的见识很感兴趣，希望你能发现更多gaKöy的物产。',
    npcId: 'Hoca Efendi',
    objectives: [{ type: 'discoverItems', label: '发现50种不同物品', target: 50 }],
    moneyReward: 1500,
    friendshipReward: [{ npcId: 'Hoca Efendi', amount: 20 }]
  },
  {
    id: 'main_3_4',
    chapter: 3,
    ...
    moneyReward: 1200,
    friendshipReward: [{ npcId: 'Hatice Abla', amount: 20 }]
  },
  {
    id: 'main_3_5',
    chapter: 3,
  ...
  },
  {
    ...
    moneyReward: 1500,
    friendshipReward: [{ npcId: 'İbo', amount: 20 }]
  },
  {
    id: 'main_3_7',
    chapter: 3,
  ...
  },
  {
    ...
    moneyReward: 2000,
    friendshipReward: [{ npcId: 'Kahveci Bekir', amount: 20 }]
  },
  {
    id: 'main_3_9',
    chapter: 3,
    ...
    moneyReward: 2000,
    friendshipReward: [{ npcId: 'Hekim Dede', amount: 20 }]
  },
  {
    id: 'main_3_10',
    chapter: 3,
    order: 10,
    title: '声名远播',
    description: '你的名声已经传到了邻村。继续积累财富，成为gaKöy的骄傲。',
    npcId: 'Muhtar Mehmet',
  ...
  },
  {
    ...
    moneyReward: 2500,
    friendshipReward: [{ npcId: 'Baran', amount: 30 }]
  },
  {
    id: 'main_4_3',
    chapter: 4,
  ...
  },
  {
    ...
    order: 9,
    title: '丰收大亨',
    description: '柳娘说你的农场是gaKöy产量最高的，继续保持。',
    npcId: 'Elif',
  ...
  },
  {
    ...
    order: 10,
    title: '富甲一方',
    description: '你的财富已经名闻乡里。柳村长说你是gaKöy的骄傲。',
    npcId: 'Muhtar Mehmet',
  ...
  // ============================================================
  {
    ...
    moneyReward: 5000,
    friendshipReward: [{ npcId: 'İsmail', amount: 30 }]
  },
  {
    id: 'main_5_2',
    chapter: 5,
  ...
  },
  {
    ...
    order: 3,
    title: '万魔之敌',
    description: '云飞说你已经是gaKöy最强的战士了，但怪物还在不断出现。',
    npcId: 'Baran',
  ...
  },
  {
    ...
    moneyReward: 3000,
    friendshipReward: [{ npcId: 'Fatma Teyze', amount: 30 }]
  },
  {
    id: 'main_5_6',
    chapter: 5,
  ...
  },
  {
    ...
    order: 8,
    title: '出货全鉴',
    description: '何掌柜希望你能把gaKöy所有物产都出货一遍。',
    npcId: 'Kahveci Bekir',
    objectives: [{ type: 'shipItems', label: '出货50种不同物品', target: 50 }],
    moneyReward: 5000,
    friendshipReward: [{ npcId: 'Kahveci Bekir', amount: 30 }]
  },
  {
    id: 'main_5_9',
    chapter: 5,
  ...
  },
  {
    ...
    order: 10,
    title: '桃源之主',
    description: '你已经成为gaKöy真正的主人。所有技能满级，财富冠绝乡里。这是最终的挑战。',
    npcId: 'Muhtar Mehmet',
    objectives: [
    ...
    moneyReward: 10000,
    itemReward: [{ itemId: 'prismatic_shard', quantity: 1 }],
    friendshipReward: [{ npcId: 'Muhtar Mehmet', amount: 50 }]
  }
]
