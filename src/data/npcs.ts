...
export const NPCS: NpcDef[] = [
  ...
  },
  {
    ...
    dialogues: {
      stranger: ['你好，你是新来的田庄主人吧？我是柳娘。', 'gaKöy很美的，{title}你会喜欢这里。'],
  ...
  },
  {
    ...
    dialogues: {
      ...
      bestFriend: ['这部《本草拾遗》，送给{title}了。好好研读。', 'gaKöy的未来，就拜托{player}了。']
    }
  },
  {
    id: 'xiao_man',
  ...
  },
  {
    ...
    dialogues: {
      ...
      acquaintance: ['今日读了一篇好文章，与{title}分享。', '"山不在高，有仙则名"——gaKöy便是如此。'],
  ...
  },
  {
    ...
    dialogues: {
      ...
      acquaintance: ['{title}也喜欢听曲子？改天弹一首给你。', '这首曲子叫《秋水》，是为gaKöy写的。'],
  ...
  },
  {
    ...
    dialogues: {
      stranger: ['你就是接手那片田庄的年轻人？我是柳村长。希望你能不辱祖辈留下的基业。', 'gaKöy的规矩，不可不守。'],
      acquaintance: ['{title}最近干得不错，村民们都说你勤快。', '柳娘跟我提过你几次……嗯。'],
      friendly: ['{player}，你为村子做的事，老夫都看在眼里。', '当年你祖父也是这般有魄力。'],
      bestFriend: ['{player}是gaKöy之福。', '老夫年事已高，这村子的未来，{title}要多担待了。']
    }
  },
  {
    id: 'qian_niang',
