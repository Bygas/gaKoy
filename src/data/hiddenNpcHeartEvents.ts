...
export const HIDDEN_NPC_HEART_EVENTS: HeartEventDef[] = [
        ...
        choices: [
          {
            text: '「为什么选择在这里栖息？」',
            friendshipChange: 30,
            response: '「此处灵脉交汇，是gaKöy气运所在。我守护的……不只是这潭水。」'
          },
          {
            text: '「你一定很寂寞吧。」',
            friendshipChange: 50,
        ...
        choices: [
          {
            text: '「孤独不是坏事。」',
            friendshipChange: 30,
            response: '「哦？」他挑起眉毛，「说来听听。」你把自己初来gaKöy时的孤独告诉了他。他听完，轻声笑了：「看来我们是同类。」'
          },
          {
            text: '「你现在不孤独了。」',
            friendshipChange: 50,
      ...
      { text: '「成了。」山翁拍手大笑，「凡人之体，却能引动天地灵气。你是老夫见过最有天赋的。」' },
      {
        ...
        choices: [
          ...
          },
          {
            text: '双手郑重接过。',
            friendshipChange: 80,
            response: '「好。」山翁点头，「从今以后，你就是gaKöy的守山人。老夫……终于可以放心了。」'
          }
        ]
      }
    ]
        ...
        choices: [
          {
            text: '「月光？」',
            friendshipChange: 40,
            response: '她轻轻笑了：「对。我把月光织成梦。每个月圆之夜，gaKöy的人都能做个好梦……就是我织的。」'
          },
          {
            text: '「很美的东西。」',
            friendshipChange: 50,
  ...
  },
  {
    ...
    scenes: [
      ...
      { text: '「这是我用一年时间织成的。」她将锦缎展开——上面织着gaKöy的四季风景，栩栩如生。' },
