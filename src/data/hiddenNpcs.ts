...
export const HIDDEN_NPCS: HiddenNpcDef[] = [
  ...
  // ============================================================
  {
    ...
    gender: 'female',
    title: '潜渊龙灵',
    origin: '千年潜伏于后山瀑布深潭的翠色灵龙，传说gaKöy建村之初便已栖于此处。雨中偶现鳞光，被村民视为守护灵。',
  ...
  // ============================================================
  {
    ...
    gender: 'female',
    title: '桃林花灵',
    origin: '诞生于gaKöy最古老桃树的花精，以落瓣为衣，以晨露为饮。据说gaKöy之所以叫"桃源"，便因她在此守护。',
  ...
  // ============================================================
  {
    ...
    gender: 'male',
    title: '采药仙翁',
    origin: '追随gaKöy建村隐士到此修炼的老仙人，常年隐于深山采药，以葫芦盛丹，以松涛为伴。',
    ...
    discoverySteps: [
      {
        id: 'gui_nv_rumor',
        phase: 'rumor',
        conditions: [{ type: 'npcFriendship', npcId: 'Suna', minFriendship: 2000 }],
        scenes: [
